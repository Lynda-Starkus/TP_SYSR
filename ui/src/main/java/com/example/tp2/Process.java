...
public class Process extends Thread{
    ...
    public void addMessage(Message message){
        ...
        for (Message m: messages){
            ...
            Main.message_type.add("recieved_processes");
            Main.message.add("Processus  "+pid+" reçu ! ");
            m.printMessage();
        }
    }

    public void printMessages() {
        System.out.println("\n\nMsesages que le processus  " + this.pid + " a reçu.");
        Main.message_type.add("recieved_messages");
        Main.message.add("\n\nMsesages que le processus  " + this.pid + " a reçu.");
